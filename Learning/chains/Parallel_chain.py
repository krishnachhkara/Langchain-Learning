#document splitting into notes and quiz using parallel chains.
...
prompt1 = PromptTemplate(
    template="generate simple and easy notes from the following text.\n {text}",
    input_variables=['text']
)

prompt2 = PromptTemplate(
    template="generate simple and easy question answer like quiz from the following text.\n {text}",
    input_variables=['text']
)

prompt3 = PromptTemplate(
    template="generate simple document from the following text.\n notes -> {notes}, quiz->{quiz}",
